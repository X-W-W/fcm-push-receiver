...
import type { ICredentials, TNotificationCb } from "./types.js";

async function listen (credentials: ICredentials, notificationCallback: TNotificationCb): Promise<Client> {
    if (!credentials) {
